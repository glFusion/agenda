	...
	calendar = $('#calendar').fullCalendar({
		...
		views: {
			month: {
				...
				columnFormat: config['month_columnformat'],
				titleFormat: config['month_titleformat'],
			},
			week : {
				...
				columnFormat: config['week_columnformat'],
				titleFormat: config['week_titleformat'],
			},
			day: {
				...
				columnFormat: config['day_columnformat'],
				titleFormat: config['day_titleformat'],
			},
			listMonth: {
